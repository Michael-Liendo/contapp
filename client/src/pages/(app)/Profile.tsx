      ...
      <form noValidate onSubmit={handleSubmit}>
        <CardContent>
          <div className='flex flex-wrap gap-5'> 
            ...
            ].map(({ label, id, value, placeholder, isEditable, onEdit }) => (
              <div key={id} className='flex gap-1 w-full sm:w-full lg:w-[30%] space-y-6'>
                <TextField
                  label={label}
                  type='text'
                  id={id}
                ...
                />
                <Button variant='outline' size='icon' type='button' onClick={onEdit}>
                  <PencilLine />
                </Button>
              </div>
            ))}
